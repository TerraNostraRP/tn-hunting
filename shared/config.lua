...
Config.Blips = {
    ...
    Blips = { -- Blips for hunting stores
        {title='Loja de Caça', colour=1, id=141, coords = vector3(-774.43, 5598.45, 33.61), scale = 0.8},
        {title='Avenida Xinoca', colour=1, id=141, coords = vector3(-639.31, -1251.77, 12.59), scale = 0.8}, 
        {title='Dealer de Animais Exótico', colour=5, id=141, coords = vector3(5611.23, -5655.02, 11.54), scale = 0.8} -- I would suggest not using a blip for illegal dealer :)
    } 
}
...
Config.Zones = {
    ...
    Zones = { -- Hunting circle zones you can add more here. These zones are purely visual we use them entirely in RP they do not affect the script in anyway.
        {title='Zona de Caça', colour=5, id=141, coords = vector3(-1186.72, 3853.52, 489.94), scale = 0.6, zonecolour = 2, radius = 950.00},
        {title='Zona de Caça', colour=5, id=141, coords = vector3(772.84, 5461.14, 560.18), scale = 0.6, zonecolour = 2, radius = 950.00}
    }
}
